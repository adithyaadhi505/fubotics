  ...
  return (
    <div ref={sectionRef}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              {[
                ...
                {
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent-600">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 glass rounded-xl text-text-primary placeholder-text-muted focus:outline-none focus:ring-1 focus:ring-white transition-all"
      ...
      <a
        ...
        shadow-lg hover:shadow-glow-white
